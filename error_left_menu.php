      ...
      <div id="left">
        ...
        <ul id="menu" class="bg-blue dker">
          ...
          <li>
            <!-- <a href="javascript:;"> -->
              <a href="javascript:;" onclick="cargare('menu.php?id=1'); return false;">
              <!-- <a href="javascript:;" onclick="cargare('content_validation_orig.php'); return false;"> -->
          ...
          <li>
            ...
            <a href="javascript:;" onclick="cargare('menu.php?id=2'); return false;">
            <!-- <a href="javascript:;" onclick="cargare('content_general_orig.php'); return false;"> -->
          ...
          <li>
            <!-- <a href="#"> -->
            <a href="javascript:;" onclick="cargare('menu.php?id=3'); return false;">  
          ...
          <li>
            ...
            <ul>
              <li>
                <a href="#">
                  <i class="fa fa-angle-right"></i>&nbsp; Opción 01 </a>
              </li>
              <li>
                <a href="#">
                  <i class="fa fa-angle-right"></i>&nbsp; Opción 02 </a>
              </li>
              <li>
                <a href="#">
                  <i class="fa fa-angle-right"></i>&nbsp; Opción 03 </a>
              </li>
