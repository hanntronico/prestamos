            ...
            <footer class="Footer bg-dark dker">
                <p>2017 &copy; CRM ALOKTECH v0.1</p>
            </footer>
            <!-- /#footer -->
            <!-- #helpModal -->
            ...
            <div id="hannModal" class="modal fade">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        ...
                        <div class="modal-body">
<!--                             <p>
                                Hann Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
                            </p> -->

<!--                             <form method="post" action="prueba.html" name="prueba">
                                <input type="text" id="valores" name="valore" value="" placeholder="">
                            </form> -->
            ...
            <!-- /.modal -->
            <!-- /#helpModal -->
            <div id="recoge" class="modal fade">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                            <h4 class="modal-title">Registro de Producto Recogido</h4>
                        </div>
                        <div class="modal-body">
                            <div id="cont_recoge"></div>
                        </div>
 <!--                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                        </div> -->
