      ...
      <div id="left">
        ...
        <!-- <div class="media user-media bg-light lter"> -->
        <div class="media user-media" style="background-color: #356fa2;">
          <div class="user-media-toggleHover">
            <span class="fa fa-user"></span>
          </div>
          <!-- <div class="user-wrapper bg-dark lter"> -->
          <!-- <div class="user-wrapper bg-light lt"> -->
          <div class="user-wrapper">
            <a class="user-link" href="">
              <img class="media-object img-thumbnail user-img" alt="User Picture" src="assets/img/user1.jpg">
            ...
            <div class="media-body">
              <!-- <h5 class="media-heading"> -->
                ...
                <?php
                  // $_SESSION["s_cod"]
                  // $_SESSION["s_tipo"]
                  echo $_SESSION["s_solonom"]."<br>";
                  // echo $_SESSION["s_nombreC"]."<br>";
                  echo $_SESSION["s_correousu"]."<br>";
                ?>
                </strong>
              <!-- </h5> -->
                ...
                <li>Acceso : <br>
                  <?php 
                    ...
                    <small>
                      ...
                      <?php 
                        // echo date("d M Y H:i"); 
                        echo date("d")." ".fechas_espanol(date('n'))." ".date("Y H:i");
                      ?>  
        ...
        <ul id="menu">
          ...
          <li class="">
            <a href="main.php">
              ...
              <span class="link-title">&nbsp;&nbsp;Panel de Control</span>
            </a>
          </li>
          
          <li>
            <!-- <a href="main.php?mnu=2"> -->
          ...
          <li>
            <!-- <a href="javascript:;"> -->
            <a href="javascript:;" onclick="cargare('bus_prestamos.php'); return false;">
              <i class="fa fa-money"></i>
              <span class="link-title">&nbsp;&nbsp;Préstamos</span>
            </a>
          </li>          

          <li>
            <!-- <a href="javascript:;" title=""> -->
            <!-- <a href="javascript:;" onclick="cargare('prendas.php'); return false;"> -->
            <a href="javascript:;" onclick="cargare('bus_prendas.php'); return false;">
              <i class="fa fa-list-alt"></i>
              <span class="link-title">&nbsp;&nbsp;Prendas</span>
            </a>
          </li> 
...
<!--             <ul>
              <li>
                <a href="#"><i class="fa fa-angle-right"></i>&nbsp; Opción 01 </a>
              </li>
              <li>
                <a href="#"><i class="fa fa-angle-right"></i>&nbsp; Opción 02 </a>
              </li>
              <li>
                <a href="#"><i class="fa fa-angle-right"></i>&nbsp; Opción 03 </a>
              </li>
            </ul> -->
          </li> 
          ...
          <li>
            <a href="javascript:;">
              ...
              <span class="link-title">&nbsp;&nbsp;Ayuda</span>
            </a>
          </li> 
...
<!--           <li>
          ...
          <li>
            <a href="typography.html">
              ...
              <span class="link-title">Typography</span>
            </a>
          </li>
          <li>
            <a href="maps.html">
              <i class="fa fa-map-marker"></i><span class="link-title">Maps</span>
            </a>
          </li>
          <li>
            <a href="chart.html">
          ...
          <li>
            <a href="blank.html">
              ...
              <span class="link-title">Blank Page</span>
            </a>
          </li> -->
...
<!--           <li>
            <a href="login.html">
              ...
              <span class="link-title">Login Page</span>
            </a>
          </li>
