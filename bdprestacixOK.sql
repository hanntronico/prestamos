...
--
-- Servidor: localhost
-- Tiempo de generación: 05-11-2018 a las 21:04:25
...
--
ALTER TABLE `pagos`
  MODIFY `codPago` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;
--
-- AUTO_INCREMENT de la tabla `prendas`
--
ALTER TABLE `prendas`
  MODIFY `idPrenda` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
--
